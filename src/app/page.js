  ...
  const renderChatHistory = () => {
    const KyraIcon = ({ isSpinning }) => (
      <svg
        ...
        className={`w-12 h-12 text-gray-400 ${isSpinning ? 'animate-spin' : ''}`}
      >
        <path
          fill="currentColor"
          d="M860.4,540.9c0,176.9-143.7,320.5-320.5,320.2c-177.5-0.2-320.3-143.7-320.2-321.6
          c0.1-176.6,144.3-320.2,321-319.7C717.9,220.3,860.5,363.5,860.4,540.9z M677.7,800.4c-1-0.4-1.7-1.1-2.5-1.1
          c-46.1-1.1-88.1-16.6-128-38.1c-85.5-46.1-154-111.1-206.9-192.2c-32.6-49.9-57-103.1-59.2-164.2c0-0.6-1-1.2-2.1-2.5
          c-22.9,43.8-33.9,89.7-34.5,138.4c-0.7,52,20.3,119.8,36.6,137.4c0.7-39.2,11.9-75.2,28.3-110.5c11.4,13.2,19.7,25.3,10,43
          c-5.2,9.4-6.9,21-9.2,31.8c-5.3,24.8-6.8,49.8,1.5,74.3c2.6,7.8,6.8,15,11.1,24.4c23.7-24.1,45.5-46.3,67.4-68.6
          c6.4,6.4,12.3,12.2,19.3,19.3c-22.4,22.2-44.6,44.1-67.3,66.6c20.9,13.8,43.8,18.7,67.3,15.3c24.3-3.5,48.1-10.7,72.1-16.3
          c3.1-0.7,6.9-2.4,9.2-1.2c7.5,4,14.5,9.1,22.9,14.6c-36.3,16.7-72.2,27.9-111.8,28.9C456.3,846.3,620.5,846.3,677.7,800.4z
          M798.9,680.9c47.4-72.4,46.9-231.4-0.1-279c-0.4,37.2-10.3,71.7-25.3,104.8c-36.9,81.6-93.4,147.6-162.9,203.2
          c-14.2,11.3-29.2,21.6-45,33.2c12.6,5.4,23.9,10.9,35.7,15.3c30.5,11.4,61.7,19,94.6,15c15.2-1.9,29.7-5.9,43.5-16.5
          c-23.1-22.7-45.3-44.5-68-66.8c6.1-5.9,11.7-11.2,18.3-17.6c22,22.6,43.8,45.2,66.4,68.4c14.6-21,18.3-42.8,17.6-65.6
          c-0.8-26.7-7.6-52.1-17.1-76.9c-1.1-2.8-1.8-6.8-0.6-9.1c3.9-7.4,8.8-14.2,14.1-22.4C787.1,603.2,798.2,639.5,798.9,680.9z
          M323.4,341.4c-32.3,42.9-14,123.4,14.7,171.3c17.4-22.7,34.8-45.6,52.3-68.4c6.9,7.2,12.3,12.7,18.1,18.8
          c-3.8,4.6-8.3,9.3-12.1,14.6c-13.8,18.9-27.5,37.9-40.8,57.2c-1.7,2.5-2.1,7.7-0.6,10.2c20,33,43.7,63.2,70.9,91.5
          c9-9,17.9-17.5,26.4-26.5c38.7-41,38-100.6-1.6-140.6c-22.9-23.2-46.1-46.1-69-69.2C362.4,380.9,343.3,361.4,323.4,341.4z
          M653.9,636.5c25.3-26.1,47-54.3,67-84.1c6.1-9.1,6.2-15.4-0.3-24c-16.4-21.8-32.1-44.1-47.1-64.8c4.7-5.9,9.7-12.1,15.8-19.6
          c18.3,24,35.5,46.6,53.2,69.8c19.6-40.7,34.5-81.7,30.4-127.2c-1.4-15.9-5.7-30.9-15.1-44c-45.5,45.2-90.7,88.9-134.4,134
          c-18.9,19.5-25.3,44.8-23.6,72.2C602.3,587.8,627.1,612.2,653.9,636.5z M679.9,280.3c-45.2-23.9-91.3-34.8-140.2-35.5
          c-53-0.7-122.9,21.7-136.8,36.6c38.9,0.8,74.7,12.2,110.9,28.9c-5.9,3.8-10.6,6.1-14.6,9.4c-7.1,5.9-13.6,5-22.3,2.6
          c-23.1-6.4-46.6-12.5-70.3-15.3c-23.2-2.8-45.8,2.3-64.6,15.6c28.3,28.5,56.2,56.6,84.3,84.8C498.4,342.7,576.2,288.3,679.9,280.3z
          M443.4,425.2c59.8,75.6,134.1,74.5,192,0.8c-27.8-27-58.4-50.6-91.4-70.8c-2.2-1.4-7-0.8-9.4,0.7c-11,6.9-22.1,13.8-32.3,21.8
          C482.3,393.1,462.9,409.3,443.4,425.2z M444.9,655.5c27.9,26.9,57.9,50.1,90.5,70c2.4,1.5,7.5,0.8,10.2-0.8
          c10.3-6.2,20.6-12.6,30.1-20c20.4-15.9,40.3-32.4,60.4-48.7C578.5,583.3,505,579.9,444.9,655.5z M737.9,323.4
          c-38.7-30.8-118.8-15.2-169.8,14.9c28.7,22.7,57.6,45.7,86.5,68.6C681.9,379.5,709.7,351.6,737.9,323.4z M581,499.6
          c-28.1,9.5-54.3,8.5-81.7,0.8c8.5,27.8,8.1,53.9-0.1,81.4c27.7-8.8,54-8.4,81.4-0.5C572.5,553.8,572.4,527.9,581,499.6z"
        />
      </svg>
    );
      ...
      React.createElement('main', { className: "flex-grow overflow-auto p-4 pt-16", key: 'main' },
        React.createElement('div', { className: "max-w-3xl mx-auto space-y-4" }, [
          React.createElement('div', { className: "mb-8 flex items-center justify-center", key: 'Kyra' }, [
            React.createElement('p', { className: "text-4xl font-bold text-gray-300 text-center mr-4" }, t('Kyra')),
